                ...
                <div class="row">
                    <div class="col-lg-6" data-aos="fade-right">
                        <div style="box-shadow:none;" class="image">
                            <img src="assets/img/cucakrowo.svg" style="" class="img-fluid" alt="">
                    ...
                    <div class="col-lg-6" data-aos="fade-left">
                        <div class="content pt-4 pt-lg-0 pl-0 pl-lg-3 ">
                            <h3>Cucak Rawa</h3>
                            <p>
                            adalah sejenis burung pengicau dari suku Pycnonotidae. Burung ini juga dikenal umum sebagai krakau, nama di Kapuas Hulu, Kalbar, cucakrawa (dalam bahasa Jawa dilafalkan sebagai [cucaʔ rɔwɔ]), cangkurawah (Sunda), dan barau-barau (Melayu). Dalam bahasa Inggris disebut Straw-headed Bulbul, mengacu pada warna kepalanya yang kuning-jerami pucat. Nama ilmiahnya adalah Pycnonotus zeylanicus (Gmelin, 1789).Burung yang berukuran sedang, 
                            panjang tubuh total (diukur dari ujung paruh hingga ujung ekor) sekitar 28 cm.
                            </p>
                            <p>
                ...
                <div class="row">
                    <div class="col-lg-6" data-aos="fade-right">
                        <div style="box-shadow:none; margin-left:25% " class="image">
                            <iframe width="440px" height="400px" src="https://www.youtube.com/embed/iNei-k0KX10" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
                            <a data-aos="fade-up" style="text-align:center;width:15%;color:black;font-size:50px;display:block;left:50%;top:45%; position:absolute;" href=""></i></a>
                        </div>
                    </div>
                    <div class="col-lg-6" data-aos="fade-left">
                        <div class="content pt-4 pt-lg-0 pl-0 pl-lg-3 ">
                            ...
                            <div id="comment_form">        
                            <form action="{{ route('simpan-cucakrowo')}}" method="post">
                                    {{ csrf_field()}}
                                <div>
